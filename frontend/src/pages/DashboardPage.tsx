...
const QUICK_STATS = [
  { label: 'Total Sessions', value: '—', icon: Activity, color: 'var(--accent)' },
  { label: 'Best Streak', value: '—', icon: Zap, color: 'var(--warning)' },
  { label: 'Avg Form Score', value: '—', icon: Target, color: 'var(--success)' },
];
